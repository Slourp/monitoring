...
function DashboardCard10() {
  return (
    <div className="col-span-full bg-white rounded-sm border shadow-lg xl:col-span-12 border-slate-200">
      ...
      <div className="p-3">
        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              <div className="my-2 mr-3 w-9 h-9 bg-indigo-500 rounded-full shrink-0">
                <svg
            ...
            {/* Item */}
            <li className="flex px-2">
              <div className="my-2 mr-3 w-9 h-9 bg-rose-500 rounded-full shrink-0">
                <svg
            ...
            {/* Item */}
            <li className="flex px-2">
              <div className="my-2 mr-3 w-9 h-9 bg-emerald-500 rounded-full shrink-0">
                <svg
        ...
        <div>
          ...
          <ul className="my-1">
            {/* Item */}
            <li className="flex px-2">
              <div className="my-2 mr-3 w-9 h-9 bg-sky-500 rounded-full shrink-0">
                <svg
