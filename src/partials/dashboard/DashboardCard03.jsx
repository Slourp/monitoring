...
function DashboardCard03() {
  ...
  return (
    <div className="flex flex-col col-span-full bg-white rounded-sm border shadow-lg sm:col-span-6 xl:col-span-3 border-slate-200">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          {/* Icon */}
          <img src={Icon} width="32" height="32" alt="Icon 03" />
          {/* Menu button */}
          <EditMenu align="right" className="inline-flex relative">
            <li>
              <Link
      ...
      <div className="grow">
        ...
        <LineChart data={chartData} width={389} height={64} />
      </div>
    </div>
  );
}
